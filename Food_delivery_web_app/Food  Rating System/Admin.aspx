<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster.Master" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="Food_App.WebForm3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    </asp:Label><asp:TextBox ID="tbUserName" runat="server"></asp:TextBox>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Enter User Name:" ControlToValidate="tbPwd"></asp:RequiredFieldValidator>
    <br /><br />
